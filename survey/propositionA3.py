...
monotonicity_instances = [
    ...
    ("rule-x", 3,
     ...
     False, [1, 4, 5], [[1, 4, 5]], [[1, 2, 5], [1, 4, 5], [2, 4, 5]]),
    ("rule-x-without-2nd-phase", 4,
     [[0, 1, 2], [0, 6], [3, 4], [1, 3, 5], [0, 5], [0, 1, 2], [7], [0, 7], [1, 7], [1, 3], [3, 4, 5], [2, 4, 7]],
     True, [4], [[0, 1, 4]], [[0, 1, 4], [0, 3, 7]]),
    ("revseqpav", 3,
     [[0, 4], [1, 2, 3], [3, 4], [2, 4], [1, 3, 4], [2, 4], [0, 1, 2], [2, 3, 4], [0, 3, 4], [1, 3],
      [0, 4], [0, 3, 4], [0, 1], [0, 3], [0, 1, 3], [2, 4], [1, 2, 3], [1, 2]],
    ...
    ("pav", 4,  # from Sanchez-Fernandez and Fisteus (2019)
     [[0, 1], [0, 1, 2], [4, 5], [4, 5]]
     + [[0, 4], [1, 4], [2, 4], [0, 5], [1, 5], [2, 5], [0, 6], [1, 6], [2, 6]] * 3 + [[3]] * 100,
     False, [2, 3], [[0, 1, 2, 3]], [[3, 4, 5, 6]]),
    ("cc", 3,  # from Sanchez-Fernandez and Fisteus (2019)
     [[a], [a, d], [a, e], [c, d], [c, e], [b]] * 2 + [[d]],
     False, [b, c], [[a, b, c]], [[a, b, c], [b, d, e]]),
    ("monroe", 4,  # from Sanchez-Fernandez and Fisteus (2019)
     [[a, e]] * 5 + [[a, g]] * 4 + [[b, e]] * 5 + [[b, h]] * 4 + [[c, f]] * 5
     + [[c, g]] * 4 + [[d, f]] * 3 + [[d, h]] * 3,
    ...
    ("seqpav", 4,  # from Sanchez-Fernandez and Fisteus (2019)
     [[a, b, d]] * 7 + [[a, b, e]] * 4 + [[a, c, d]] * 3 + [[a, c, e]] * 5,
     True, [c, d], [[a, b, c, d]], [[a, b, d, e]]),
    ("seqcc", 3,
     [[0], [0], [0, 1, 2], [0, 3], [0, 3], [1], [1], [1, 3], [2], [2], [2], [3]],
     True, [1, 2], [[0, 1, 2]], [[0, 1, 2], [0, 2, 3], [1, 2, 3]]),
    ("seqcc", 3,
     [[4], [0], [0], [0, 1, 2], [0, 3], [0, 3], [1], [1], [1, 3], [2], [2], [2], [3]],
     False, [1, 2], [[0, 1, 2]], [[0, 1, 2], [0, 2, 3], [1, 2, 3]]),
    ...
    ("optphrag", 6,  # from Sanchez-Fernandez and Fisteus (2019)
     ...
     [[0, 1, 2, 3, 4, 6], [0, 1, 2, 3, 5, 6], [0, 1, 2, 4, 5, 6], [0, 1, 3, 4, 5, 6], [0, 2, 3, 4, 5, 6]]),
    ("mav", 5,  # from Sanchez-Fernandez and Fisteus (2019)
     [[5], [1], [2], [3], [1, 4, 6], [1, 4, 7], [1, 5, 6], [1, 5, 7], [1, 6]],
     False, [1, 2, 3, 4], [[1, 2, 3, 4, 5]], [[1, 2, 3, 6, 7]]),
]
